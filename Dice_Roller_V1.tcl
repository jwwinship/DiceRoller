...
# File: Dice_Roller_V1.tcl
# Generated on: Mon Dec 11 14:01:03 2023
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "Dice_Roller_V1"]} {
		puts "Project Dice_Roller_V1 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists Dice_Roller_V1]} {
		project_open -revision Dice_Roller_V1 Dice_Roller_V1
	} else {
		project_new -revision Dice_Roller_V1 Dice_Roller_V1
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name QIP_FILE architectureV1/synthesis/architectureV1.qip
	set_global_assignment -name VERILOG_FILE ../../top.v
	set_global_assignment -name VERILOG_FILE ../../SIPO.v
	set_global_assignment -name VERILOG_FILE ../../RNG.v
	set_global_assignment -name VERILOG_FILE ../../postProcess.v
	set_global_assignment -name VERILOG_FILE ../../interface.v
	set_global_assignment -name VERILOG_FILE ../../GARO.v
	set_global_assignment -name VERILOG_FILE DE0_CV_golden_top.v
